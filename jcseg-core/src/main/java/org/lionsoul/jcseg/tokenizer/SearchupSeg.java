 ...
 * @since   1.9.8
*/
public class SearchupSeg extends ASegment
{
    
    public SearchupSeg(JcsegTaskConfig config, ADictionary dic) throws IOException
    {
        super(config, dic);
    }
    
    public SearchupSeg(Reader input, JcsegTaskConfig config, ADictionary dic) throws IOException
    {
